...
import (
	...
	"simplelogic/models" //models package dimana Buku didefinisikan
...
type response struct {
	...
	Data    []models.Buku `json:"data,omitempty"`
}
...
func TmbhBuku(w http.ResponseWriter, r *http.Request) {
	...
	datamodel := []models.Buku{}

	// format response objectnya
	res := response{
		ID:      insertID,
		Message: "Data buku telah ditambahkan this your data %n", Data: datamodel,
	}
